...
#define MQTT_CMD_SUBSCRIBE_TOPIC   		"dev/cmd/STM32F446RE/mpu6050"
#define DEFAULT_MQTT_PUBLISH_TOPIC 		"dev/update/STM32F446RE/mpu6050"
#define MQTT_CLIENT_ID                  "Struts4EmbeddedWithStm32F446RE"

#define LINE_LED_RED                  	LINE_LED_GREEN
...
#define MPU_SCL_PIN						PAL_LINE(GPIOB, 10U)//LINE_ARD_D15-7th from bottom right 2nd column
#define MPU_SDA_PIN						PAL_LINE(GPIOB, 3U)//LINE_ARD_D14-4th from bottom right 2nd column
#define MPU_I2C_AF						4
#define MPU_I2CD						I2CD2
//#define LINE_ARD_D2                 PAL_LINE(GPIOA, 10U)--3rd from bottom right 2nd column
