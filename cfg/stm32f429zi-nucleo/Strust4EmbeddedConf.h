...
#define MQTT_CMD_SUBSCRIBE_TOPIC   		"dev/cmd/STM32F429ZI/mpu6050"
#define DEFAULT_MQTT_PUBLISH_TOPIC 		"dev/update/STM32F429ZI/mpu6050"
...
#define MPU_SCL_PIN						PAL_LINE(GPIOB, 10U)//LINE_ARD_D15-Brown-last far right hand pin
#define MPU_SDA_PIN						PAL_LINE(GPIOB, 11U)//LINE_ARD_D14--white 2nd-last far right hand pin
#define MPU_I2C_AF						4
